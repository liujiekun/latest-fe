    ...
    <div class="layout_inner">
      <div class="main-head">
        ...
        <div class="main-option">
          <el-button type="primary" size="small" @click.native.prevent="createPeriodMange()" v-loading.fullscreen.lock="fullscreenLoading">保存</el-button>
        </div>
      </div>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-select v-model="scope.row.apPeriodStatus" placeholder="请选择" style="width: 100%">
              <el-option
                v-for="item in apPeriodOptions"
...
<script>
import api from '../store/apperiodmangeapi'
