<template>
  <div>
    <div class="el-breadcrumb ever_breadcrumb">
      <ever-bread-crumb :name="name" show-edit-fnt="false" :have-return="true"></ever-bread-crumb>
    </div>
    <div id="sourcelist">
      <el-row class="pd20">
        <el-col :span="24">
...
export default {
  ...
  data () {
    ...
    queryObj.start = ''
    queryObj.end = ''
    queryObj.parentId = this.$route.query.id
    return {
