<template>
  <el-dialog title="分类管理" :visible.sync="dialog" @close="closeDialog"  id="classList" class="ui_dialog_02">
    <el-row class="mb20">
    ...
    <el-table :data="tableData">
      ...
      <el-table-column prop="templateNum" label="模版数量" width="120" align="center"></el-table-column>
...
<script>
  import api from '../store/classapi'
  export default {
    data () {
      return {
        api: api,
