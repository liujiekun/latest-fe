...
<script>
  ...
  import {seatTypeColumns} from '@/warehouse/page/building/views/seat/model'
  ...
  export default {
    ...
    methods: {
      ...
      toPage () {
        this.$router.push({name: 'building-seatType-detail', params: {type: 'create', id: '-1'}})
      },
      eventChange ({prop, row}) {
        this[prop] && this[prop](row)
      },
      edit ({id}) {
        this.$router.push({name: 'building-seatType-detail', params: {id, type: 'edit'}})
      },
    },
  }
</script>
