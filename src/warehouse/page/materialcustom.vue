...
<script>
import api from '../store/materialapi'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      customUnit: null,
      toPath: this.$route.params.wareType ? `/warehouse/materialcustom/${this.$route.params.groupId}/${this.$route.params.wareType}/${this.$route.params.id}` : `/warehouse/materialcustom/${this.$route.params.groupId}/${this.$route.params.id}`
    }
  },
  methods: {
    submitForm: function () {
