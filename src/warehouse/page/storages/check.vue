<template>
  <div class="ever-tab">
    <div v-if="$route.name == 'checkstocktakingadd' || $route.name == 'checklist'" class="settle_inner">
      <el-row>
        <el-col :span="24">
          <el-menu class="settlemenu">
            <el-menu-item @click="$router.push('/storages/check/checkstocktakingadd')" :class="$route.name == 'checkstocktakingadd' ? 'is-active' : 'is-inactive'" index="checkstocktakingadd">
              新建盘点
            </el-menu-item>
            <el-menu-item @click="$router.push('/storages/check/checklist')" :class="$route.name == 'checklist' ? 'is-active' : 'is-inactive'" index="checklist">
              盘点列表
            </el-menu-item>
          </el-menu>
        </el-col>
