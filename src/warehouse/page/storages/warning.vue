<template>
  <div class="ever-tab">
    <div v-if="$route.name == 'inventorywarn' || $route.name == 'validitywarn'" class="settle_inner">
      <el-row>
        <el-col :span="24">
          <el-menu class="settlemenu">
            <el-menu-item @click="$router.push('/storages/warning/inventorywarn')" :class="$route.name == 'inventorywarn' ? 'is-active' : 'is-inactive'" index="inventoryWarn">
              库存预警
            </el-menu-item>
            <el-menu-item @click="$router.push('/storages/warning/validitywarn')" :class="$route.name == 'validitywarn' ? 'is-active' : 'is-inactive'" index="validityWarn">
              效期预警
            </el-menu-item>
          </el-menu>
        </el-col>
