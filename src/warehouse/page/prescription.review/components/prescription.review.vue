  ...
  <div>
    <div class="prescription-layout">
      ...
      <div class="pos_re">
        ...
        >
          <div class="patient-table pos_re" style="margin-top: 10px;">
            <el-button
              class="pos_ab"
              type="text"
              style="top: 7px"
            ...
            <el-table
              ...
              <el-table-column v-if="expandTable" width="157" label="开方时间">
                <template slot-scope="scope">
          ...
          <div class="clinic-container" v-if="tableData.length">
            ...
            >
              <div class="clinic_content">
                ...
                <!-- 处方点评 -->
                <submit-comment :submitData="submitData" :showEditBtn="false" @submitComment="submitComment"></submit-comment>
              </div>
            </div>
          </div>
...
export default {
  props: {
    doctorId: {
      type: String,
      default: 'f49aba21-9b0a-11e9-af36-0242ac110005'
    }
  },
  mixins: [getStorage, sendDrug, mixinsDespen, selectInquireList],
  data () {
    return {
      api,
      queryObj: {},
  ...
  methods: {
    ...
    _initDate () {
      ...
      this.queryObj.doctorId = this.doctorId
      this.queryObj.date = [
    ...
    visitList (params, type) {
      ...
      if ((this.visitType === 3 && !this.queryObj.time.length) || (this.visitType === 1 && !this.queryObj.date.length)) {
        return this.$messageTips(this, 'warning', '查询时间不能为空')
      }
