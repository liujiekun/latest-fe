    ...
    >
      <el-table-column prop="date" width="65">
        ...
        <template slot-scope="scope">
          <el-op :value="scope.row" :index="scope.$index" @change="changeCode"></el-op>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="address" label="手术级别" width="26">
        <template slot-scope="scope">
          <m-grade :value="scope.row" :index="scope.$index" @change="change"></m-grade>
        </template>
      </el-table-column>
      <el-table-column prop="date" width="100">
        ...
        <template slot-scope="scope">
          <el-input
            ...
            :rows="3"
            placeholder="—"
            v-model="scope.row[SHOU_SHU_NAME]"
          ></el-input>
        </template>
      </el-table-column>
      <el-table-column prop="name" width="80">
        ...
        <el-table-column prop="name" width="80" label="术者">
          <template slot-scope="scope">
            <m-input :value="scope.row" :index="scope.$index" @change="change" :prop="SHU_ZHE"></m-input>
          </template>
        </el-table-column>
        <el-table-column prop="name" width="80" label="Ⅰ助">
          <template slot-scope="scope">
            <m-input :value="scope.row" :index="scope.$index" @change="change" :prop="YI_ZHU"></m-input>
          </template>
        </el-table-column>
        <el-table-column prop="name" width="80" label="Ⅱ助">
          <template slot-scope="scope">
            <m-input :value="scope.row" :index="scope.$index" @change="change" :prop="ER_ZHU"></m-input>
          </template>
        </el-table-column>
      </el-table-column>
      <el-table-column prop="address" label="麻醉方式">
        <template slot-scope="scope">
          <el-mazui :value="scope.row" :index="scope.$index" @change="changeMazui"></el-mazui>
        </template>
      </el-table-column>
      <el-table-column prop="address" label="切口愈合等级" width="72">
        <template slot-scope="scope">
          <m-qiekou :value="scope.row" :index="scope.$index" @change="change"></m-qiekou>
        </template>
      </el-table-column>
      <el-table-column prop="address" label="麻醉医师">
        <template slot-scope="scope">
          <m-input :value="scope.row" :index="scope.$index" @change="change" :prop="MA_ZUI_SHI"></m-input>
        </template>
      </el-table-column>
    </el-table>
  </div>
