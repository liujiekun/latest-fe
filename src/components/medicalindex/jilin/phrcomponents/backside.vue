      ...
      <el-form :inline="true" :model="form" size="mini">
        ...
        <el-form-item label="1.综合医疗服务类" class="mt10" :prop="YI_BAN_YI_LIAO_FEI">
          ...
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZHONG_ZHI_FEI" @change="change"></m-input>
          </div>中医辨证论治会诊费
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZHONG_ZHEN_FEI" @change="change"></m-input>
          </div>)
          (2)一般治疗操作费
          <div class="wid120 inline">
        ...
        <el-form-item label="5.中医类(中医和民族医医疗服务)" class="mt10" :prop="ZY_ZHI_LIAO">
          (12)中医诊断
          <div class="wid120 inline">
            <m-input :value="value" :prop="ZY_ZHEN_DUAN" @change="change"></m-input>
          </div>
          <br />(13)中医治疗
          <div class="wid120 inline">
            <m-input :value="value" :prop="ZY_ZHI_LIAO" @change="change"></m-input>
          </div>(中医外治
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_WAI_ZHI" @change="change"></m-input>
          </div>中医骨伤
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_GU_SHANG" @change="change"></m-input>
          </div>针刺与灸法
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_ZHEN_CI" @change="change"></m-input>
          </div>中医推拿治疗
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_TUI_NA" @change="change"></m-input>
          </div>
          <br />中医肛肠治疗
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_GANG_CHANG" @change="change"></m-input>
          </div>中医特殊治疗
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_TE_SHU" @change="change"></m-input>
          </div>)
          <br />(14)中医其他
          <div class="wid120 inline">
            <m-input :value="value" :prop="ZY_QI_TA" @change="change"></m-input>
          </div>(中药特殊调配加工
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_TIAO_PEI" @change="change"></m-input>
          </div>辨证施膳
          <div class="birth_add inline">
            <m-input :value="value" :prop="ZY_SHI_SHAN" @change="change"></m-input>
          </div>)
        </el-form-item>
        ...
        <el-form-item label="7.中药类" :prop="ZHONG_CHENG_YAO">
          ...
          <div class="wid120 inline">
            <m-input :value="value" :prop="ZHONG_CAO_ZHI_JI" @change="change"></m-input>
          </div>)(17)中草药费
          <div class="wid120 inline">
