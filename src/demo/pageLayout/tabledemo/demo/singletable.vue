<template>
  <div class="layout_inner">
    <el-row>
      <el-col :span="24">
        <p>单选框表格，在默认表格基础上，可以实现单选效果</p>
        <p>表格内有单选操作并且需要高亮选中行时，必须添加 highlight-current-row</p>
        <p>其他情况均不添加 highlight-current-row 大家根据实际情况来添加该属性</p>
        <el-table v-loading.body="loading" :data="tableData" highlight-current-row>
