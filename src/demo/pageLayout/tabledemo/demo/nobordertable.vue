<template>
  <div class="layout_inner">
    <el-row>
      <el-col :span="24">
        <p>没有任何边框，需要加上class no-border；
          注意：默认表格都有一个hover效果，如果该表格不需要hover，则需要加上 no-hover
          如果表格需要反色效果的hover，则需要加上 table-hover-blue，
          如果希望表格的间距较小，可以加上 none-padding
        </p>
        <el-table
          v-loading.body="loading"
          :data="tableData"
          highlight-current-row
          class="no-border table-hover-blue none-padding"
        >
