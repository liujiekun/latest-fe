<template>
  <div class="">
    ...
    <div class="layout_inner oh h100 auto-height-wrap">
          ...
          <div class="sort-box oh h100 df fdc">
            <div class="sort-title">
              ...
              <el-button size="mini" type="text" @click="insertPageChart">
                <i class="icon iconfont icon-PHR-charufenyema mr2"></i>插入换行符
              </el-button>
            </div>
            ...
            <div class="sort-ul auto-height oxhya">
              <!--          <div class="sort-li" v-for="item in sortList.filter(s => s)">{{item.paramValue}}</div>-->
              <draggable v-if="sortList.length" v-model="sortList" @end="resetSort">
                <transition-group>
                  ...
                  >
                    ...
                    <!--                    <span v-else @click="clearSeparate(element, index)">清除</span>-->
                  </div>
                </transition-group>
              </draggable>
