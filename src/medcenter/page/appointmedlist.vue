<template>
  <div id="appointlist" class="layout_inner">
    <appoint-list :operator="true" :type="1" :reset="reset" :isTijian="true" @edit="editAppoint">
      <el-button>
        <a class="cGray" v-if="hnFlag === '2'" :href="this.$ever.crmIndex + '/crm/HnMemberadd'" target="_blank">患者建档</a>
        <a class="cGray" v-if="hnFlag === '1'" :href="this.$ever.crmIndex + '/crm/memberadd'" target="_blank">患者建档</a>
      </el-button>
    ...
    <add-appoint :show.sync="showAddAppoint" :init="init" :isTijian="true" @success="appointSuccess"></add-appoint>
