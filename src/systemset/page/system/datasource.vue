  ...
  <div class="layout_inner">
    ...
    >
      <template slot="expand" slot-scope="scope">
        <template class="expand-ul" v-if="scope.row.gouppingDataSets && scope.row.gouppingDataSets.length">
          <ever-table
            border
            :show-header="false"
            show-expand
            :row-class-name="rowClassName"
            :columns="columns"
            :data="scope.row.gouppingDataSets"
            @eventChange="eventChange"
          ></ever-table>
        </template>
      </template>
  ...
  export default {
    data: function () {
      ...
      return {
        ...
        queryObj,
        dialogQueryObj,
        url: urlMap.dataSet.getDataSetListInfo,
    ...
    methods: {
      ...
      rowClassName ({row}) {
        if (!(row.gouppingDataSets && row.gouppingDataSets.length)) {
